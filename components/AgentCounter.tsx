  ...
  return (
    <div className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-2.5">
      <span className="relative flex h-2.5 w-2.5">
        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#b9ff66] opacity-60" />
        <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#b9ff66]" />
      </span>
